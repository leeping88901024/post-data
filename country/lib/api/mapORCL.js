...
var mapped = function mapped(url, rows) {
    switch (url) {
        case 'api/bloodstation/businessinfo/reagent/update':
            // 1
            var ret1 = rows.map(function (x) {
                return {
                    Customize_KID: x[0],
                    Sbm: x[1],
                    Jc_xm: x[2],
